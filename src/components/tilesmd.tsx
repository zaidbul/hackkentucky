...
const TILES_HASH = "a1b43dy6";

const TilesMD = memo(({ className }: { className?: string }) => {
  // Use a static URL with hash for proper caching
  const jsonUrl = useMemo(() => `/tilesmd.json?v=${TILES_HASH}`, []);
...
TilesMD.displayName = "TilesMD";

export default TilesMD;